  ...
  <header class="fixed top-0 bg-white/97 bg-blur left-0 w-full z-50 border-b border-gray-200">
    <nav class="container mx-auto px-4 h-20 flex items-center">
      ...
      <button
        ...
        class="lg:hidden fixed top-6 right-4 z-50 p-2"
      ...
      <!-- Mobile Menu -->
      <div
        class="lg:hidden fixed inset-0 bg-white z-40 transition-opacity duration-300"
      ...
      >
        <div class="container mx-auto px-4 pt-32 flex flex-col items-center space-y-6">
          ...
          <div class="flex flex-col space-y-4 w-full max-w-xs mt-4">
            <NuxtLink
              to="/reservations"
              class="bg-primary/10 text-primary px-8 py-3 rounded-full hover:bg-primary/20 transition-colors duration-200 text-xl text-center"
              @click="isMenuOpen = false"
            >
              Online Ordering
            </NuxtLink>
            <NuxtLink
              to="/reservations"
              class="bg-red-600 text-white px-8 py-3 rounded-full hover:bg-red-700 transition-colors duration-200 text-xl text-center"
              @click="isMenuOpen = false"
            >
              Reservations
            </NuxtLink>
