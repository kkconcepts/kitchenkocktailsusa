...
<template>
  <LayoutContain class="f-pt-32-48 mx-auto max-w-90rem f-py-40-80">
    <div class="w-full">
          ...
          >
            <div class="relative overflow-hidden hover:cursor-pointer">
              <NuxtImg
                ...
                :alt="location.city"
                class="w-full h-full hidden object-cover hover:scale-101 transition-transform hover:opacity-96 transition-opacity ease-in-out duration-300"
                quality="80"
                format="webp"
              />
            </div>
