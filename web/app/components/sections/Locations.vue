        ...
        <div class="flex flex-col w-full mb-15">
          <div class="flex justify-between items-end w-full">
            <div class="flex flex-col justify-start items-start">
              <p
                class="f-text-11-12 mb-10 text-start tracking-0.75 font-semibold uppercase text-brand-accent"
              >
                Find Your City
              </p>
              <h1
                class="f-text-24-40 leading-9 tracking-0.25 font-gt-ultra font-medium text-start uppercase"
              >
      ...
      <div class="relative min-h-15rem" data-grid>
        <Transition name="fade" mode="out-in">
          ...
          >
            ...
            >
              <div class="relative aspect-1.5 overflow-hidden hover:cursor-pointer">
                <NuxtImg
