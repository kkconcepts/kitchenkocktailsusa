...
<template>
  <div class="page-content relative min-h-screen w-full f-py-60-100 bg-black/90">
    <div class="relative z-10 container mx-auto px-4 py-12 max-w-4xl">
      <Transition name="fade" mode="out-in">
        <div
          v-if="formSubmitted"
          class="flex flex-col items-center justify-center text-center py-16 space-y-6"
        >
          ...
          <p class="text-gray-300 max-w-md">
            Thank you for your interest in hosting an event with us. Our team will review your
            ...
            <Transition name="fade" mode="out-in">
              <div :key="currentStep">
                      ...
                      <div class="flex flex-col">
                        ...
                        <div class="relative">
                          ...
                          >
                            ...
                            <option value="birthday" class="text-white">
                ...
                <div v-else-if="currentStep === 2" class="space-y-6">
                  ...
                  <div class="flex flex-col">
                    <label class="text-sm font-medium text-gray-300 mb-2"
