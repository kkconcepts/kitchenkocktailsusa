    ...
    <section class="min-h-100vh max-w-3xl m-auto f-py-160-180">
      <LayoutContain>
        <div class="flex flex-col f-gap-32-48 leading-regular">
          ...
          <div class="flex flex-col">
            <h2 class="text-2xl font-bold mb-4">Our Commitment to Your Privacy</h2>
            <p>
          ...
          <div class="border-color-[#e2a368] divider border"></div>
          <div class="flex flex-col">
            <h3 class="text-xl font-bold mb-6">What We Collect & Why It Matters</h3>
            <p>
              ...
              <br />
              Please do not submit any confidential, proprietary or sensitive personally
              identifiable information (e.g. Social Security Number; driver’s license number; or
              credit card, bank account or other financial information). If you do you do so at your
              own risk and we will not be liable to you or responsible for consequences of your
              submission.
              <br /><br />
              <strong>Information We Share</strong>
              <br />
              We do not disclose any non-public personal information about our customers or former
              customers to any non-affiliated entity except as described below and otherwise
              required by law. We may disclose all of the information we collect, as described
              above, to provider companies that assist us in the servicing or administration of the
              service you have requested or authorized. When information is shared with companies
              that perform services on our behalf, we protect against the subsequent disclosure of
              that information. In no event do we disclose your personal information to companies
              that will use that information to contact you about their own products or services.
              <br /><br />
              We may also disclose your personal information if required to do so by law (for
              example, a subpoena) or regulation, or in good faith to:
              <br />
              ...
              web server logs helps us administer the site, analyze its usage, protect the website
              ...
              applications may use cookies to store and help track information about you. Cookies
              are simply small pieces of data that are sent to your browser from a Web server and
              stored on your computer’s hard drive. We use cookies to help remind us who you are and
              to help you navigate our sites during your visits. Cookies allow us to save passwords
              and preferences for you so you won’t have to re-enter them each time you visit. The
              use of cookies is relatively standard. Most browsers are initially set up to accept
              cookies. However, if you prefer, you can set your browser to either notify you when
              you receive a cookie, or to refuse to accept cookies. You should understand that some
              features of many sites may not function properly if you don’t accept cookies.
              <br /><br />
              ...
              revise, change, or modify this Privacy Policy at time. We will incorporate all
              material changes to this Privacy Policy on this page and will provide advance notice
              to you. Such notice may be given in any manner we choose that complies with law,
              including, but not limited to posting a notice of such changes on the Web Sites. We
              encourage you to review this page periodically for the most recent version of this
              Privacy Policy. Any use by a User of the Web Sites following notice of such changes
              shall be deemed to constitute acceptance by that User of those changes to the Privacy
              Policy.
              <br /><br />
              <strong>Questions</strong>
              <br />
              If you have questions about this Notice, or would like to review or make changes to
              your personal information, please e-mail us at
              <a
