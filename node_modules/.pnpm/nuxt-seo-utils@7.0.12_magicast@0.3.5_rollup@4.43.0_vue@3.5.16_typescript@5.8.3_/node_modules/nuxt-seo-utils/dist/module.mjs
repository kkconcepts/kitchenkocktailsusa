import { useNuxt, createResolver, addTemplate, defineNuxtModule, useLogger, addServerHandler, hasNuxtModule, addPlugin, addImports, addVitePlugin } from '@nuxt/kit';
import UnheadVite from '@unhead/addons/vite';
import { defu } from 'defu';
import { installNuxtSiteConfig } from 'nuxt-site-config/kit';
import { unpackMeta } from '@unhead/vue/utils';
import fg from 'fast-glob';
import { relative, resolve, extname, dirname, basename } from 'pathe';
